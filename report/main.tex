...
\newpage
\input{sections/03_writing_style}
\newpage
\input{sections/04_figures_tables}
\newpage
\input{sections/05_algorithms_code}
\newpage
\input{sections/06_citations}
\newpage
\input{sections/07_latex_tips}
\newpage
\input{sections/08_common_mistakes}
\newpage
\input{sections/09_checklist}
\newpage
